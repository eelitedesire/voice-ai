/**
 * Privacy-First RAG Types
 *
 * Types for the agentic RAG system that powers the AI co-therapist's
 * contextual understanding of each couple's relationship dynamics.
 */
